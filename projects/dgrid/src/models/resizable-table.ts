...
export abstract class ResizableTable extends Table implements OnInit {
    ...
    @Output()
    public readonly activeRowIndexChange: EventEmitter<number> = new EventEmitter<number>();
    @Input()
    public activeRowIndex: number;
    @Input()
    public snapline: Element;
    @ViewChildren(fromDirective.SortTableColumnDirective)
    public sortColumns: QueryList<fromDirective.SortTableColumnDirective>;
